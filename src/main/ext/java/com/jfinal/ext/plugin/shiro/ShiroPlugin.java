...
public class ShiroPlugin implements IPlugin {
     ...
     * @param genUrl
     */
    public ShiroPlugin(Routes routes, boolean genUrl) {
        this.routes = routes;
        this.genUrl = genUrl;
    }
    ...
    public boolean start() {
         ...
         * 设定登录，登录成功，未授权等url地址
         */
        ShiroKit.setLoginUrl(genUrl ? genUrl(loginUrl) : loginUrl);
        ShiroKit.setSuccessUrl(genUrl ? genUrl(successUrl) : successUrl);
        ShiroKit.setUnauthorizedUrl(genUrl ? genUrl(unauthorizedUrl) : unauthorizedUrl);
        ShiroKit.setLogoutUrl(genUrl ? genUrl(logoutUrl) : logoutUrl);
        return true;
    }
    ...
    private String createActionKey(Class<? extends Controller> controllerClass, Method method, String controllerKey) {
        ...
        if (ak != null) {
            ...
            if ("".equals(actionKey)) throw new IllegalArgumentException(
     ...
     * @param successUrl
     */
    public final ShiroPlugin setSuccessUrl(String successUrl) {
     ...
     * @param loginUrl
     */
    public final ShiroPlugin setLoginUrl(String loginUrl) {
        this.loginUrl = loginUrl;
        return this;
    }

    public final ShiroPlugin setLogoutUrl(String logoutUrl) {
     ...
     */
    public final ShiroPlugin setUnauthorizedUrl(String unauthorizedUrl) {
        this.unauthorizedUrl = unauthorizedUrl;
        return this;
    }

    protected String genUrl(String action) {
        return action;
    }
}
